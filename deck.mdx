...
<Notes>
  ...
  short development cycle. BDD also writes tests before code. BDD writes tests
  from the users perspective? More on BDD in out example. TODO: What is
  TDD?????? OPINION: When your boss hands you a big project... say adding an
  additional page to you app with a lot of logic that your going to have to
  create. My thought is to create a unit test(that fails) create the function to
  pass the test and then create the next unit test etc etc...
</Notes>
