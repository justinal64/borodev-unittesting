...
<img width="100%" height="600px" src="./img/pacman.png"/>
<span style={{ position: 'absolute', top: '250px', top: '200px', fontSize: 60, left: 0, right: 0, margin: 'auto', fontFamily: 'system-ui'}}>
    <h1>Unit Testing</h1>
    <h1>Your Front End Code</h1>
</span>
